...
var DisableTelemetryTests = (function (_super) {
    __extends(DisableTelemetryTests, _super);
    function DisableTelemetryTests() {
        _super.apply(this, arguments);
    }
    /** Method called before the start of each test method */
    DisableTelemetryTests.prototype.testInitialize = function () {
    ...
    /** Method called after each test method has completed */
    DisableTelemetryTests.prototype.testCleanup = function () {
        console.log("cleanup");
        this.useFakeServer = true;
        this.useFakeTimers = true;
    };
    DisableTelemetryTests.prototype.registerTests = function () {
        var _this = this;
