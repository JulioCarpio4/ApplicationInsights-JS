...
var Sanitizer2ETests = (function (_super) {
    __extends(Sanitizer2ETests, _super);
    function Sanitizer2ETests() {
        _super.apply(this, arguments);
    }
    /** Method called before the start of each test method */
    Sanitizer2ETests.prototype.testInitialize = function () {
    ...
    /** Method called after each test method has completed */
    Sanitizer2ETests.prototype.testCleanup = function () {
        this.useFakeServer = true;
        this.useFakeTimers = true;
    };
    Sanitizer2ETests.prototype.setAppInsights = function () {
    ...
    Sanitizer2ETests.prototype.registerTests = function () {
        var _this = this;
        ...
        this.delay = 100;
        var boilerPlateAsserts = function (mocks) {
