...
var ValidateTests = (function (_super) {
    __extends(ValidateTests, _super);
    ...
    ValidateTests.prototype.testInitialize = function () {
    ...
    ValidateTests.prototype.testCleanup = function () {
        this.useFakeServer = true;
        this.useFakeTimers = true;
    };
    ValidateTests.prototype.registerTests = function () {
        var _this = this;
        ...
        this.testCaseAsync({
            ...
            steps: [
                function () {
                    _this.testAi.trackEvent("test");
                    _this.testAi.trackEvent("test event", { p1: "value 1", p2: "value 2" }, { m1: 123, m2: 456.7 });
                }]
                .concat(this.waitForResponse())
                .concat(this.boilerPlateAsserts)
                .concat(function () {
                var acceptedItems = _this.successSpy.args[0][1];
        ...
        this.testCaseAsync({
            ...
            steps: [
                function () {
                    _this.testAi.trackEvent("test event", { p1: "value 1" }, { m1: "invalid" });
                }]
                .concat(this.waitForResponse())
                .concat(function () {
                Assert.ok(!_this.successSpy.called, "success not called");
                Assert.ok(_this.errorSpy.called, "error called");
                var result = JSON.parse(_this.errorSpy.args[0][1]);
        ...
        this.testCaseAsync({
            ...
            steps: [
                function () {
                    ...
                    // white spaces
                    _this.testAi.trackEvent(" abcd efg   ", { " abc ": "value 1", " ": "value 2" });
                    // international characters
                    _this.testAi.trackEvent(s1, { p: s2 });
                    _this.testAi.trackEvent(s3, { p: s4 });
                    _this.testAi.trackEvent(s5, { p: s6, p2: s7 });
                }]
                .concat(this.waitForResponse())
                .concat(this.boilerPlateAsserts)
                .concat(function () {
        ...
        this.testCaseAsync({
            ...
            steps: [
                function () {
                    var s1 = "[]{};,.)(*&^%$#@/\\";
                    _this.testAi.trackEvent(s1, { p: s1 });
                    _this.testAi.trackEvent("a", { "[]{};,.)(*&^%$#@/\\": "b" });
                }]
                .concat(this.waitForResponse())
                .concat(this.boilerPlateAsserts)
                .concat(function () {
    ...
    ValidateTests.prototype.waitForResponse = function () {
        var _this = this;
        return PollingAssert.createPollingAssert(function () {
            return (_this.successSpy.called || _this.errorSpy.called);
        }, "Wait for response" + new Date().toISOString(), 5, 1000);
    };
    ValidateTests.prototype.boilerPlateAsserts = function () {
    ...
    ValidateTests.prototype.parseResponse = function (response) {
        var result = JSON.parse(response);
        if (result && result.itemsReceived && result.itemsReceived >= result.itemsAccepted &&
            result.itemsReceived - result.itemsAccepted == result.errors.length) {
            return result;
