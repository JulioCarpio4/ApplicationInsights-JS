...
var AutoCollectionTests = (function (_super) {
    __extends(AutoCollectionTests, _super);
    function AutoCollectionTests() {
        _super.apply(this, arguments);
    }
    /** Method called before the start of each test method */
    AutoCollectionTests.prototype.testInitialize = function () {
        this.useFakeTimers = false;
        this.clock.restore();
        this.errorSpy = this.getListener("ErrorSpy");
    };
    /** Method called after each test method has completed */
    AutoCollectionTests.prototype.testCleanup = function () {
        this.useFakeTimers = true;
        this.errorSpy.reset();
    };
    AutoCollectionTests.prototype.registerTests = function () {
        var _this = this;
        var delay = 5000;
        this.testCaseAsync({
            ...
            steps: [
                function () {
                    _this.loadErrorTest("ajax");
                }
            ].concat(this.poll(function () {
                return _this.verifyAjax(_this.errorSpy, [
                    {
        ...
        this.testCaseAsync({
            ...
            steps: [
                function () {
                    _this.loadErrorTest("errorDom");
                }
            ].concat(this.poll(function () {
                return _this.verifyErrorMessages(_this.errorSpy, [
        ...
        this.testCaseAsync({
            ...
            steps: [
                function () {
                    _this.loadErrorTest("errorScriptGlobal");
                }
            ].concat(this.poll(function () {
                return _this.verifyErrorMessages(_this.errorSpy, [
                    // General errors
        ...
        this.testCaseAsync({
            ...
            steps: [
                function () {
                    _this.loadErrorTest("errorScriptNested");
                }
            ].concat(this.poll(function () {
                return _this.verifyErrorMessages(_this.errorSpy, [
                    //General Error message
        ...
        this.testCaseAsync({
            ...
            steps: [
                function () {
                    _this.loadErrorTest("errorScriptSyntax");
                }
            ].concat(this.poll(function () {
                return _this.verifyErrorMessages(_this.errorSpy, [
                    // IE specific error messages
    ...
    AutoCollectionTests.prototype.getListener = function (address) {
        var listener = { onMessage: function () { return null; } };
    ...
    AutoCollectionTests.prototype.loadErrorTest = function (path) {
    ...
    AutoCollectionTests.prototype.poll = function (func, count) {
        var _this = this;
    ...
    AutoCollectionTests.prototype.getTelemetryItemsFromMessage = function (args, telemetryType) {
        var items = [];
    ...
    AutoCollectionTests.prototype.getExceptionsFromMessage = function (args) {
        var exceptions = [];
        for (var i = 0; i < args.length; i++) {
            var payload = args[i][0];
            var data = JSON.parse(payload.data);
    ...
    AutoCollectionTests.prototype.verifyAjax = function (spy, expectedItems) {
        if (spy.called) {
            var args = spy.args;
    ...
    AutoCollectionTests.prototype.verifyErrorMessages = function (spy, expectedMessages, numberOfTests) {
        var done = false;
        if (spy.called) {
            var args = spy.args;
