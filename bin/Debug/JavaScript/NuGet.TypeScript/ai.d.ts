...
declare module Microsoft.ApplicationInsights {
    ...
    */
    ...
    class AppInsights implements IAppInsightsInternal, IAppInsights {
         ...
         */
        startTrackPage(startDate?: Date): any;
        startTrackPage(name?: string, startDate?: Date): any;
        /**
         * Logs how long a page or other item was visible, after {@link startTrackPage}. Call this when the page closes.
         * @param   name  The string you used as the name in startTrackPage. Defaults to the document title.
         * @param   url   String - a relative or absolute URL that identifies the page or other item. Defaults to the window location.
         ...
         */
        stopTrackPage(name?: string, url?: string, properties?: Object, measurements?: Object, endDate?: Date): void;
        /**
         * Logs that a page or other item was viewed.
         * @param   name  The string you used as the name in startTrackPage. Defaults to the document title.
         * @param   url   String - a relative or absolute URL that identifies the page or other item. Defaults to the window location.
